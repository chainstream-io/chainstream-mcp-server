import { ChainStreamClient, ChainSymbol } from '@chainstream-io/sdk';
...
export class RedpacketResource {
  @ResourceTemplate({
    ...
    description: `Create a new red packet with specified amount and quantity.
      ...
      **API Docs**: https://docs.chainstream.io/en/api-reference/endpoint/redpacket/v2/redpacket-chain-create-post`,
    mimeType: 'application/json',
    uriTemplate:
      'mcp://dex/redpacket/create/{chain}?creator={creator}&mint={mint}&maxClaims={maxClaims}&totalAmount={totalAmount}&fixedAmount={fixedAmount}&memo={memo}&password={password}&claimAuthority={claimAuthority}',
  })
  ...
  @ResourceTemplate({
    ...
    description: `Claim tokens from an existing red packet.
      ...
      **API Docs**: https://docs.chainstream.io/en/api-reference/endpoint/redpacket/v2/redpacket-chain-claim-post`,
    mimeType: 'application/json',
    uriTemplate:
      'mcp://dex/redpacket/claim/{chain}?claimer={claimer}&packetId={packetId}&shareId={shareId}&password={password}',
  })
  ...
  @ResourceTemplate({
    ...
    description: `Query red packet information by ID.
      ...
      **API Docs**: https://docs.chainstream.io/en/api-reference/endpoint/redpacket/v2/redpacket-id-get`,
    mimeType: 'application/json',
  ...
  @ResourceTemplate({
    ...
    description: `Query red packet claim records by ID.
      ...
      **API Docs**: https://docs.chainstream.io/en/api-reference/endpoint/redpacket/v2/redpacket-id-claims-get`,
    mimeType: 'application/json',
    uriTemplate:
      'mcp://dex/redpacket/getClaims/{id}?cursor={cursor}&limit={limit}&direction={direction}',
  })
  async getRedpacketGetClaims(req: Request, { uri, id }) {
    try {
      ...
      const client = new ChainStreamClient(accessToken);
      const result = await client.redPacket.getClaims(id, {
        cursor,
        limit,
        direction,
      });
  ...
  @ResourceTemplate({
    ...
    description: `Get the red packets list with filters and pagination.
      ...
      **API Docs**: https://docs.chainstream.io/en/api-reference/endpoint/redpacket/v2/redpacket-get`,
    mimeType: 'application/json',
    uriTemplate:
      'mcp://dex/redpacket/list?cursor={cursor}&limit={limit}&direction={direction}&creator={creator}&chain={chain}',
  })
  async getRedpacketGetList(req: Request, { uri }) {
    try {
      ...
      const chainFilter = (url.searchParams.get('chain') || undefined) as ChainSymbol | undefined;

      const client = new ChainStreamClient(accessToken);
      const result = await client.redPacket.getRedpackets({ cursor, limit, direction, creator, chain: chainFilter });
        ...
        contents: [
          {
            ...
            text: JSON.stringify(
              {
                filters: { cursor, limit, direction, creator, chain: chainFilter },
                result,
                count: result?.records?.length ?? 0,
                pagination: {
                  total: result?.total,
  ...
  @ResourceTemplate({
    ...
    description: `Query red packet claim records by wallet address.
      ...
      **API Docs**: https://docs.chainstream.io/en/api-reference/endpoint/redpacket/v2/redpacket-wallet-address-claims-get`,
    mimeType: 'application/json',
    uriTemplate:
      'mcp://dex/redpacket/getClaimsByAddress/{address}?cursor={cursor}&limit={limit}&direction={direction}',
  })
  async getRedpacketGetClaimsByAddress(req: Request, { uri, address }) {
    try {
      ...
      const client = new ChainStreamClient(accessToken);
      const result = await client.redPacket.getClaimsByAddress(address, {
        cursor,
        limit,
        direction,
      });
  ...
  @ResourceTemplate({
    ...
    description: `Get the red packets list created by a specific address.
      ...
      **API Docs**: https://docs.chainstream.io/en/api-reference/endpoint/redpacket/v2/redpacket-wallet-address-redpackets-get`,
    mimeType: 'application/json',
    uriTemplate:
      'mcp://dex/redpacket/getRedpacketsByAddress/{address}?cursor={cursor}&limit={limit}&direction={direction}',
  })
  async getRedpacketGetByAddress(req: Request, { uri, address }) {
    try {
      ...
      const client = new ChainStreamClient(accessToken);
      const result = await client.redPacket.getRedpacketsByAddress(address, {
        cursor,
        limit,
        direction,
      });
  ...
  @ResourceTemplate({
    ...
    description: `Send a signed red packet transaction to the blockchain.
      ...
      **API Docs**: https://docs.chainstream.io/en/api-reference/endpoint/redpacket/v2/redpacket-chain-send-post`,
    mimeType: 'application/json',
  ...
  async getRedpacketSend(req: Request, { uri, chain }) {
    try {
      ...
      const client = new ChainStreamClient(accessToken);
      const result = await client.redPacket.redpacketSend(chain, {
        signedTx,
      });
